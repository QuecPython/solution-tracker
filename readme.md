...
| 2.2.0   | 2023-04-14 | 孙健       | 调整Tracker功能架构    |
...
![](./docs/media/tracker_application.png)

## 移远Tracker及其能力

### 产品能力

- **通道支持阿里云、腾讯云、ThingsBoard等多种云平台(目前暂只支持阿里云和ThingsBoard, 其他平台正在开发中)**
- **支持本地和远程参数配置**
- **支持OTA升级**
- **支持数据离线存储**
