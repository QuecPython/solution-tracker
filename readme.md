...
| :------ | ---------- | ---------- | ------------------------------------------ |
| 1.0     | 2022-01-01 | 孙健       | 初始版本                                    |
| 2.0     | 2022-03-15 | 孙健       | 本次更新内容较多，烦请检阅全文。               |
...
![](./docs/CN/media/tracker_process.png)
...
![](./docs/CN/media/tracker_funcion.png)
...
![](./docs/CN/media/tracker_application.png)
...
![](./docs/CN/media/QPYCom_V3.3.0.png)
...
- **低成本开发**
    ...
    ![C2Py.png](./docs/CN/media/C2Py.png)
...
![](./docs/CN/media/tracker_alert.png)

### 远程控制

![](./docs/CN/media/solution-tracker-102.png)
